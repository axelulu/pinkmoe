 ...
 * @LastEditTime: 2022-08-07 09:05:22
 * @FilePath: /pinkmoe_index/src/pages/search/index.vue
    ...
    <div class="lg:w-3/4 xl:w-5/12">
      <div class="p-4 bg-white dark:bg-gray-700 rounded-md mt-4">
        ...
        <div class="flex flex-row pt-4">
          <div class="text-xs text-gray-500 dark:text-gray-200 font-semibold pr-6 py-1">分类</div>
