 ...
 * @LastEditTime: 2022-08-19 08:09:53
  ...
  <UserCenterLayout>
    <Spin :show="loading" class="flex flex-wrap">
      <form ref="formPublish" class="ml-6" onsubmit="return false">
        ...
        >
          <div
            class="absolute -top-3 text-xs bg-sky-600 px-1.5 py-1 text-white ml-4 cursor-pointer"
          >
          ...
          <div class="flex flex-col items-center px-4 pb-4 mt-6">
            ...
            >
              <font-awesome-icon
                ...
                :icon="['fas', 'hand-paper']"
              />
              <span class="ml-2 text-xs text-gray-500 dark:text-gray-200 select-none"
                >添加图片</span
              >
              <input
