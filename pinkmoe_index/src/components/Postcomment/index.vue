 ...
 * @LastEditTime: 2022-08-07 09:10:58
          ...
          <div class="flex flex-row w-full">
            <div class="w-14">
              <img
                ...
                v-lazy="comment.FormUidRelation.avatar ? '/' + comment.FormUidRelation.avatar : ''"
                alt="用户"
              />
            </div>
                ...
                <div v-for="(item, index) in comment.children" :key="index">
                  ...
                  >
                    <div class="text-xs text-gray-500 dark:text-gray-200 py-2 flex flex-row">
                      ...
                      :
                      <div class="flex flex-row" v-html="item.content"> </div>
                    </div>
                    <div
                  ...
                  <CommentContent @showComment="emit('showComment', null)" :item="item" />
                </div>
              </div>
            </div>
          </div>
