 ...
 * @LastEditTime: 2022-08-07 09:11:14
...
<template>
  <!-- Publishrecategory -->
  <div class="flex flex-row bg-gray-200" v-if="item.children">
    <div>
      <div
        ...
        :class="
          currentCategory.slug === item.slug && currentCategory.type !== 'all'
            ...
            : 'text-gray-500'
        "
        class="text-xs select-none text-center w-26 px-16 py-2 hover:bg-pink-400 dark:text-gray-200 hover:text-white px-2 py-1 duration-300 cursor-pointer"
      >
        {{ item.name }}
