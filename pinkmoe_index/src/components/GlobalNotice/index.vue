 ...
 * @LastEditTime: 2022-08-07 09:10:22
 * @FilePath: /pinkmoe_index/src/components/GlobalNotice/index.vue
  ...
  <transition name="fade" @after-leave="afterLeave" @after-enter="afterEnter">
    ...
    >
      ...
      >
        ...
        >
        <font-awesome-icon
          class="absolute -top-1 -right-1 dark:bg-gray-700 dark:hover:bg-gray-900 dark:hover:text-gray-100 dark:text-gray-300 bg-gray-300 hover:bg-gray-100 hover:text-gray-800 text-gray-700 duration-300 rounded-full w-2 h-2 p-1"
          @click="handleClose"
          :icon="['fas', 'xmark']"
        />
      </div>
