 ...
 * @Date: 2022-05-01 16:52:33
 * @LastEditors: coderzhaolu && izhaicy@163.com
 * @LastEditTime: 2022-08-07 09:19:15
 * @FilePath: /pinkmoe_admin/src/layout/components/Header/index.vue
      ...
      const iconList = [
        {
          ...
          tips: 'github',
          eventObject: {
            click: () => window.open('https://github.com/Coder-ZhaoLu'),
          },
        },
        {
          icon: 'LockOutlined',
