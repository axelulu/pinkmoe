 ...
 * @LastEditTime: 2022-08-07 09:26:20
 * @FilePath: /pinkmoe_admin/src/views/userCenter/report/CreateEditForm.vue
...
<template>
  <n-modal v-model:show="showForm" :show-icon="false" preset="dialog" title="新建">
    ...
    >
      ...
      <n-form-item label="图标" path="icon">{{icon}}
        <BasicUpload
          :action="`${uploadUrl}/api/Admin/Upload/FileUpload`"
          :headers="uploadHeaders"
          :data="{'post_id': null, 'uuid': userMeta.uuid, 'type': 'topic'}"
          max-size="1"
          max-number="1"
          v-model:value="icon"
