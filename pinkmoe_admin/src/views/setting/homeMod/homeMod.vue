 ...
 * @LastEditTime: 2022-08-08 16:12:30
 * @FilePath: /pinkmoe_admin/src/views/setting/homeMod/homeMod.vue
  ...
  <div>
    <n-card :bordered="false" class="mt-4 proCard">
      <div class="BasicForm">
        ...
        >
          <n-form-item path="popular" label="首页幻灯片文章">
            <n-select
          ...
          <n-form-item path="recommend" label="首页推荐文章">
            <n-select
              v-model:value="formParams.recommend"
              :render-label="renderPostLabel"
              :render-tag="renderPostSelectTag"
              :options="postList"
              clearable
