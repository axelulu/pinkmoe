 ...
 * @Date: 2022-05-01 12:26:03
 * @LastEditors: coderzhaolu && izhaicy@163.com
 * @LastEditTime: 2022-08-07 09:24:03
 * @FilePath: /pinkmoe_admin/src/views/extension/pluginShop/pluginShop.vue
...
<script lang="ts" setup>
        ...
        actions: [
          {
            label: '购买插件',
            type: 'info',
            onClick: handleBuy.bind(null, record),
            ifShow: () => {
              return true;
            },
            // auth: ['basic_list'],
  ...
  function handleBuy(record: Recordable) {
    formType.value = 'edit';
