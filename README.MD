...
`curl -L https://github.com/Coder-ZhaoLu/pinkmoe/releases/download/pinkmoe/install.sh -o /etc/pinkmoe && echo "alias pinkmoe='bash /etc/pinkmoe'" > ~/.bashrc && source ~/.bashrc && pinkmoe`
