...
3. 输入`curl -L https://github.com/kvannew/pinkmoe/releases/download/pinkmoe/install.sh -o /etc/pinkmoe && echo "alias pinkmoe='bash /etc/pinkmoe'" > ~/.bashrc && source ~/.bashrc`执行程序安装命令
