...
func (a *setting) Initialize() error {
	entities := []model.XdSetting{
		{Name: "网站设置", Slug: "website_basic", Value: "{\"title\":\"粉萌次元｜PinkMoe\",\"keyword\":\"PinkMoe|粉萌次元|ACG|ACGN|游戏|动漫|二次元|动漫下载|动漫图片|影视下载|无修动漫\",\"desc\":\"欢迎大家来到粉萌次元～\",\"color\":\"rgba(255, 178, 178, 1)\",\"icon\":[\"/uploads/file/default/avatar.png\"],\"background\":[\"/uploads/file/default/background.jpeg\"],\"logo\":[\"/uploads/file/default/avatar.png\"],\"createTime\":\"2007.06.30 12:08:55\"}"},
		...
		{Name: "系统上传", Slug: "system_oss", Value: "{\"ossType\":\"local\",\"localConfig\":{\"path\":\"uploads/file\"},\"aliyunOssConfig\":{\"endpoint\":\"https://oss-cn-hangzhou.aliyuncs.com\",\"accessKeyId\":\"LTAI5t7XaNgEBpr6AEW6Juwo\",\"accessKeySecret\":\"99qQlsknQTc9QGw4kESmzD2l45Etet\",\"bucketName\":\"pinkmoe\",\"bucketPoint\":\"https://pinkmoe.coderzhaolu.com\"},\"tencentCOSConfig\":{\"bucket\":\"\",\"region\":\"\",\"secretId\":\"\",\"secretKey\":\"\",\"baseUrl\":\"\",\"pathPrefix\":\"\"},\"qiniuConfig\":{\"zone\":\"\",\"bucket\":\"\",\"imgPath\":\"\",\"useHttps\":false,\"accessKey\":\"\",\"secretKey\":\"\",\"useCdnDomains\":false},\"huaWeiObsConfig\":{\"Path\":\"\",\"bucket\":\"\",\"endpoint\":\"\",\"accessKey\":\"\",\"secretKey\":\"\"}}"},
	}
