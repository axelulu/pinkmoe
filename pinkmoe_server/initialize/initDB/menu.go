...
func (m *menu) Initialize() error {
	entities := []model.XdBaseMenu{
		...
		{Hidden: false, ParentId: 0, Path: "/monitor", Name: "monitor", Component: "LAYOUT", Sort: 2, Meta: model.Meta{Title: "系统监控", Icon: "DesktopOutline"}},
		...
		{Hidden: false, ParentId: 0, Path: "/content", Name: "content", Component: "LAYOUT", Sort: 3, Meta: model.Meta{Title: "文章内容", Icon: "ReaderOutline"}},
		...
		{Hidden: false, ParentId: 22, Path: "goods", Name: "goods", Component: "/shop/goods/goods", Sort: 0, Meta: model.Meta{Title: "商品管理", Icon: ""}},
		{Hidden: false, ParentId: 22, Path: "goodsCategory", Name: "goodsCategory", Component: "/shop/category/category", Sort: 1, Meta: model.Meta{Title: "商品分类", Icon: ""}},
		{Hidden: false, ParentId: 0, Path: "/userCenter", Name: "userCenter", Component: "LAYOUT", Sort: 5, Meta: model.Meta{Title: "用户中心", Icon: "People"}},
		{Hidden: false, ParentId: 25, Path: "key", Name: "key", Component: "/userCenter/key/key", Sort: 0, Meta: model.Meta{Title: "卡密管理", Icon: ""}},
		{Hidden: false, ParentId: 25, Path: "report", Name: "report", Component: "/userCenter/report/report", Sort: 1, Meta: model.Meta{Title: "反馈管理", Icon: ""}},
		{Hidden: false, ParentId: 0, Path: "/forum", Name: "forum", Component: "LAYOUT", Sort: 6, Meta: model.Meta{Title: "论坛管理", Icon: "ChatbubblesOutline"}},
		{Hidden: false, ParentId: 0, Path: "/android", Name: "android", Component: "LAYOUT", Sort: 7, Meta: model.Meta{Title: "app管理", Icon: "LogoAndroid"}},
		{Hidden: false, ParentId: 0, Path: "/setting", Name: "setting", Component: "LAYOUT", Sort: 8, Meta: model.Meta{Title: "网站设置", Icon: "CogSharp"}},
		{Hidden: false, ParentId: 30, Path: "basic", Name: "basic", Component: "/setting/basic/basic", Sort: 0, Meta: model.Meta{Title: "基本设置", Icon: ""}},
		{Hidden: false, ParentId: 30, Path: "reward", Name: "reward", Component: "/setting/reward/reward", Sort: 1, Meta: model.Meta{Title: "用户奖励", Icon: ""}},
		{Hidden: false, ParentId: 30, Path: "level", Name: "level", Component: "/setting/level/level", Sort: 2, Meta: model.Meta{Title: "用户等级", Icon: ""}},
		{Hidden: false, ParentId: 30, Path: "userShop", Name: "userShop", Component: "/setting/userShop/userShop", Sort: 2, Meta: model.Meta{Title: "用户商城", Icon: ""}},
		{Hidden: false, ParentId: 30, Path: "shopMod", Name: "shopMod", Component: "/setting/shopMod/shopMod", Sort: 2, Meta: model.Meta{Title: "商城模块", Icon: ""}},
		{Hidden: false, ParentId: 30, Path: "search", Name: "search", Component: "/setting/search/search", Sort: 3, Meta: model.Meta{Title: "网站搜索", Icon: ""}},
		{Hidden: false, ParentId: 30, Path: "homeMod", Name: "homeMod", Component: "/setting/homeMod/homeMod", Sort: 4, Meta: model.Meta{Title: "首页模块", Icon: ""}},
		{Hidden: false, ParentId: 30, Path: "footer", Name: "footer", Component: "/setting/footer/footer", Sort: 5, Meta: model.Meta{Title: "底部内容", Icon: ""}},
		{Hidden: false, ParentId: 0, Path: "/log", Name: "log", Component: "LAYOUT", Sort: 9, Meta: model.Meta{Title: "登陆管理", Icon: "LogInOutline"}},
		{Hidden: false, ParentId: 0, Path: "/style", Name: "style", Component: "LAYOUT", Sort: 10, Meta: model.Meta{Title: "主题外观", Icon: "ColorPaletteOutline"}},
		{Hidden: false, ParentId: 0, Path: "/extension", Name: "extension", Component: "LAYOUT", Sort: 11, Meta: model.Meta{Title: "扩展插件", Icon: "ExtensionPuzzleOutline"}},
		{Hidden: false, ParentId: 41, Path: "plugin", Name: "plugin", Component: "/extension/plugin/plugin", Sort: 0, Meta: model.Meta{Title: "我的插件", Icon: ""}},
		{Hidden: false, ParentId: 41, Path: "pluginShop", Name: "pluginShop", Component: "/extension/pluginShop/pluginShop", Sort: 1, Meta: model.Meta{Title: "插件商店", Icon: ""}},
	}
