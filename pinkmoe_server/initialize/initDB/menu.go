...
func (m *menu) Initialize() error {
	entities := []model.XdBaseMenu{
		...
		{Hidden: false, ParentId: 4, Path: "user", Name: "user", Component: "/system/user/user", Sort: 0, Meta: model.Meta{Title: "用户管理", Icon: ""}},
		{Hidden: false, ParentId: 4, Path: "role", Name: "role", Component: "/system/role/role", Sort: 1, Meta: model.Meta{Title: "角色管理", Icon: ""}},
		{Hidden: false, ParentId: 4, Path: "api", Name: "api", Component: "/system/api/api", Sort: 2, Meta: model.Meta{Title: "接口管理", Icon: ""}},
		{Hidden: false, ParentId: 4, Path: "menu", Name: "menu", Component: "/system/menu/menu", Sort: 3, Meta: model.Meta{Title: "菜单管理", Icon: ""}},
		{Hidden: false, ParentId: 0, Path: "/monitor", Name: "monitor", Component: "LAYOUT", Sort: 1, Meta: model.Meta{Title: "系统监控", Icon: "DesktopOutline"}},
		{Hidden: false, ParentId: 9, Path: "userOnline", Name: "userOnline", Component: "/monitor/userOnline/userOnline", Sort: 0, Meta: model.Meta{Title: "在线用户", Icon: ""}},
		{Hidden: false, ParentId: 9, Path: "loginLog", Name: "loginLog", Component: "/monitor/loginLog/loginLog", Sort: 1, Meta: model.Meta{Title: "登陆日志", Icon: ""}},
		{Hidden: false, ParentId: 9, Path: "operation", Name: "operation", Component: "/monitor/operation/operation", Sort: 2, Meta: model.Meta{Title: "操作日志", Icon: ""}},
		{Hidden: false, ParentId: 0, Path: "/content", Name: "content", Component: "LAYOUT", Sort: 2, Meta: model.Meta{Title: "文章内容", Icon: "ReaderOutline"}},
		{Hidden: false, ParentId: 13, Path: "post", Name: "post", Component: "/content/post/post", Sort: 0, Meta: model.Meta{Title: "文章管理", Icon: ""}},
		{Hidden: false, ParentId: 13, Path: "category", Name: "category", Component: "/content/category/category", Sort: 1, Meta: model.Meta{Title: "分类管理", Icon: ""}},
		{Hidden: false, ParentId: 13, Path: "topic", Name: "topic", Component: "/content/topic/topic", Sort: 2, Meta: model.Meta{Title: "话题管理", Icon: ""}},
		{Hidden: false, ParentId: 13, Path: "comment", Name: "comment", Component: "/content/comment/comment", Sort: 3, Meta: model.Meta{Title: "评论管理", Icon: ""}},
		{Hidden: false, ParentId: 0, Path: "/userCenter", Name: "userCenter", Component: "LAYOUT", Sort: 3, Meta: model.Meta{Title: "用户中心", Icon: "People"}},
		{Hidden: false, ParentId: 18, Path: "key", Name: "key", Component: "/userCenter/key/key", Sort: 1, Meta: model.Meta{Title: "卡密管理", Icon: ""}},
		{Hidden: false, ParentId: 18, Path: "report", Name: "report", Component: "/userCenter/report/report", Sort: 2, Meta: model.Meta{Title: "反馈管理", Icon: ""}},
		...
		{Hidden: false, ParentId: 24, Path: "basic", Name: "basic", Component: "/setting/basic/basic", Sort: 0, Meta: model.Meta{Title: "基本设置", Icon: ""}},
