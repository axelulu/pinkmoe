 ...
 * @LastEditTime: 2022-08-07 08:54:34
 * @FilePath: /pinkmoe_server/model/response/xd_comment.go
...
type XdComment struct {
	...
	FormUidRelation model.XdUser `gorm:"foreignKey:FormUid;references:UUID"`
	ToUidRelation   model.XdUser `gorm:"foreignKey:ToUid;references:UUID"`
